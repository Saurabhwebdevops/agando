...
export const Footer = ({ logo }) => {
  ...
  return (
    ...
    <div className="chat-form-start">
      <h4 className="margin">Fill the details to chat</h4>
      <form action="">
        <label htmlFor="name">Enter your full name</label>
        <input type="text" name="chat_name" id="" onChange={chatValue} />
        <label htmlFor="email">Enter your Email</label>
        <input type="email" name="chat_email" id="" onChange={chatValue} />
        <label htmlFor="phone">Enter your valid phone number</label>
        <input type="tel" name="chat_phone" id="" onChange={chatValue} />
